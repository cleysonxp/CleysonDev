...
export function Formacao() {
  ...
  return (
    <section id="formacao" className="bg-dark py-20 text-white relative">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          {formacoes.map((item, index) => (
            <motion.div
              key={index}
              className={`relative mb-12 md:mb-20 flex flex-col md:flex-row items-center ${index % 2 === 0 ? "md:flex-row-reverse" : ""
                }`}
            ...
            >
              ...
              {/* Card */}
              <div
                className={`card w-full md:w-[45%] ${index % 2 === 0 ? "md:ml-auto" : "md:mr-auto"
                  }`}
              >
